...
async function fetchAssets() {
  try {
    ...
    tbody.innerHTML = `<tr><td colspan="9">âŒ Error loading assets</td></tr>`;
  }
}
...
async function issueAsset(assetNumber) {
  ...
  try {
    ...
    console.error(err);
    alert("âŒ Server error while issuing asset");
  }
}
...
async function receiveAsset(assetNumber) {
  ...
  try {
    ...
    console.error(err);
    alert("âŒ Server error while receiving asset");
  }
}
...
async function deleteAsset(assetNumber) {
  ...
  try {
    ...
    console.error(err);
    alert("âŒ Server error while deleting asset");
  }
}
